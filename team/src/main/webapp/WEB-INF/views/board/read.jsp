					...
					<tr>
						<td colspan="2">
							<div style="width: 100px; margin: 0 auto;">
								...
								</a> <a style="display: none" href='javascript:void(0)'
									class='badBtn badge badge-pill badge-light' data-html='true'
									title='<small>비호감</small>'> <i
									class='far fa-thumbs-down mr-2'>${boardDTO.bbad}</i>
								</a>
							</div>
