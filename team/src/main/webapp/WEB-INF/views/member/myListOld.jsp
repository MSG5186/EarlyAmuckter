...
<div class="container">
	...
	<h3 class="text-center p-3 mb-3 bg-white font-weight-bolder">내가 작성한 글목록</h3>
		<table class="table table-sm" summary="내가 작성한 글목록">
			...
			<tbody>
				...
				<tr>
					<td>${boardDTO.bnum }</td>
					<td>
					<a class="text-decoration-none text-reset" href="/board/view?bnum=${boardDTO.bnum }
